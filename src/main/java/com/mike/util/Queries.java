...
public class Queries {
    ...
    public static final String INSERT_BLOCK = "INSERT INTO block (color, pattern, shape) VALUES (:color, :pattern, :shape)";
    ...
    public static final String UPDATE_BLOCK = "UPDATE block SET color = :color , pattern = :pattern, shape = :shape where id = :id;";
    ...
    public static final String DELETE_BLOCK = "DELETE FROM block where id = :id";
}
